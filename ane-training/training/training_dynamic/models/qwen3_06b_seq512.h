// qwen3_06b_seq512.h — Qwen3-0.6B (28 layers, GQA 16q/8kv, head_dim=128) SEQ=512
#pragma once

#define MODEL_NAME "Qwen3-0.6B-seq512"
...
#define CKPT_PATH "ane_qwen3_dyn_seq512_ckpt.bin"
